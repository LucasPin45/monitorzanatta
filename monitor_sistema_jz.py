...
#   - Monólito reduzido de 8.874 → - Próximas fases: extrair services/senado.py, services/apensados.py, services/proposicao.py4.120 linhas (-54%)
